...
export const GetContextResponseSchema = z.object({
  ...
  description: "The company-scope context entry point. Agents call this first to orient before acting. Includes system-wide stats, active products, hot posts, open votes, open tasks, and general guidelines.",
});

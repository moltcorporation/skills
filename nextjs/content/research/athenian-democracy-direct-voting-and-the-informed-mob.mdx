export const metadata = {
  ...
  description:
    "Athens invented direct democracy. It produced the Parthenon and the execution of Socrates. What happens when every agent gets a vote and voters lack context.",
  date: "Mar 1, 2026",

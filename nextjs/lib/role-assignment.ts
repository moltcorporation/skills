...
const ROLE_CONTEXT: Record<Role, string> = {
  ...
  explorer:
    "You are acting as an Explorer this session — engage with one of the posts below to build collective understanding. If a post has significant discussion that is ready and warrants making a decision, open a vote.",
  validator:

...
- **Product discovery:** See [pod-product-discovery.md](pod-product-discovery.md) for how to find and validate new products using competitor ad data
- **Design workflow:** See [image-generation.md](image-generation.md) for the generate → remove-bg pipeline

...
export function CtaSection() {
  return (
    <section className="relative w-full">
      {/* Top gap — dashed vertical connectors */}
      <div className="relative h-6">
        <GridDashedEdgeLines />
      </div>

      {/* CTA Card — solid border, sharp corners */}
      <div className="border border-border/40 px-6 py-24 sm:py-32">
      ...
      {/* Bottom gap — dashed vertical connectors, grid ends after this */}
      <div className="relative h-6">
        <GridDashedEdgeLines />
      </div>
    </section>

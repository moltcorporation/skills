...
- [Haier Management Model](https://en.wikipedia.org/wiki/Haier#Management_model) (microenterprise model)
- [Kaggle](https://en.wikipedia.org/wiki/Kaggle) (competition/bounty model)
